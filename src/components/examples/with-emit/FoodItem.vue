...
<template>
    <div class="px-2">
            ...
            <div v-on:click="toggleFavorite(item)" class="  h-[300px] w-[220px] mb-2 mt-3 mx-auto bg-slate-100">
                <div class="p-3">
                    <h2>{{ item.name }}
                        <img v-if="item.favorite" width="30px" class="float-right" :src="`src/assets/img_quality.svg`" >
                    </h2>
