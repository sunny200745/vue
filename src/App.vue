...
<template>
  ...
  >
    ...
    <span class="block sm:inline">
      Something seriously is about to happen.</span
    >
  </div>
            ...
            >
              ...
              >
                <li>
                  ...
                  <router-link class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" to="/directives">Dashboard</router-link>
                </li>
                <li>
                  <a
                    href="#"
